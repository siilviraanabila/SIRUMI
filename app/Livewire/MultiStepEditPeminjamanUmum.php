...
class MultiStepEditPeminjamanUmum extends Component
{
    public $gedung;
    public $ruangan;
    ...
    public function render()
    {
        ...
        return view('livewire.multi-step-edit-peminjaman-umum', compact('peminjaman','listGedung','listRuangan','events'));
    }
    ...
    public function updatePeminjamanUmum(){
