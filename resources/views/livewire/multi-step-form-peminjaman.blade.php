<div>
    <form method="POST" wire:submit.prevent="storePeminjaman" class="employee-form">
        @csrf
            ...
            <ol class="flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base">
                <li class="flex md:w-full items-center text-blue-600 dark:text-blue-500 sm:after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
                    <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
                        ...
                        <span class="hidden sm:inline-flex sm:ms-2">Tempat & acara</span>
                    </span>
                </li>
                <li class="flex md:w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
                    <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
                        <span class="me-2">2</span>
                        <span class="hidden sm:inline-flex sm:ms-2">Tambahan fasilitas</span>
                    </span>
                </li>
                <li class="flex md:w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-200 after:border-1 after:hidden sm:after:inline-block after:mx-6 xl:after:mx-10 dark:after:border-gray-700">
                    <span class="flex items-center after:content-['/'] sm:after:hidden after:mx-2 after:text-gray-200 dark:after:text-gray-500">
                        <span class="me-2">3</span>
                        <span class="hidden sm:inline-flex sm:ms-2">Waktu peminjaman</span>
                    </span>
                </li>
        ...
        <div id="halaman" class="mx-auto max-w p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="step-two mt-6">
                ...
                <div class="flex items-center mb-4">
                    <!-- <input id="nasi-box-checkbox" type="checkbox" value="nasi-box-checkbox" wire:model="konsumsi" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> -->
                ...
                <div class="flex items-center mb-4">
                    <!-- <input id="snack-checkbox" type="checkbox" value="snack-checkbox" wire:model="konsumsi" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> -->
                ...
                <div class="flex items-center mb-4">
                    <!-- <input id="prasmanan-checkbox" type="checkbox" value="prasmanan-checkbox" wire:model="konsumsi" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"> -->
        ...
        <div id="halaman" class="mx-auto max-w p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="step-four mt-6">
                ...
                <label for="tanggal-peminjaman" class="mt-2 block mb-2 text-l font-medium text-gray-900 dark:text-white">Tanggal dan Waktu Peminjaman</label>
                    <input type="text" id="tanggal" name="tanggal" value="{{ \Carbon\Carbon::parse($data['tanggal'])->isoFormat('D MMMM YYYY', 'Do MMMM YYYY') }} , {{ $data['waktu_mulai'] }} - {{ $data['waktu_selesai'] }}" disabled class="block w-56 p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">             
            </div>
        </div>
        @endif
