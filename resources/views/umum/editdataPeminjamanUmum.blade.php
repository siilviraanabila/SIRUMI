        ...
        <div style="margin-left: 16rem;">
            <div id="halaman" class="mx-auto max-w p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="flex items-center justify-between p-1 text-gray-900 dark:text-white">
                    <a href="{{ route('getDataPeminjamanUmum') }}" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-l px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Back
                    </a>
                </div>
                <div class="mb-4">
                ...
                @livewire('multi-step-edit-peminjaman-umum', ['id' => $peminjaman->peminjaman_id])
                <script>
