...
<body style="background-color: #D3F0FF;"> 
    ...
    <section id="home" class="pt-5">
        <div style="margin-left: 16rem;">
            <form class="max-w-md mx-auto" method="GET" action="{{ route('searchUmum') }}">  
                ...
                <div class="relative">
                    ...
                    <input type="search" id="default-search" name="searchUmum" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search Gedung, Ruangan, Kapasitas" required />
